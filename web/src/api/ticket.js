...
export function getTicketTypes() {
  return request({
    url: '/ticketing/ticket-types', // 移除/api前缀
    method: 'get',
  })
}
...
export function getSalesStatistics(params) {
  return request({
    url: '/ticketing/tickets/sales/stats', // 移除/api前缀
    method: 'get',
...
export function searchTicketSales(params) {
  return request({
    url: '/ticketing/tickets/sales/search',
    method: 'get',
    params,
  })
}
...
export function getReservations(params) {
  return request({
    url: '/ticketing/reservations/search', // 移除/api前缀
    method: 'get',
    params,
  })
}
export function getReservationById(id, params) {
  return request({
    url: `/ticketing/reservations/${id}`,
    method: 'get',
    params,
  })
}
export function createReservation(data) {
  // 假设后端的创建接口就是 POST /ticketing/reservations
...
export function getPromotions(params) {
  return request({
    url: '/ticketing/promotions', // 移除/api前缀
    method: 'get',
    params,
  })
}
...
export function getTicketInfo(ticketId) {
  // 使用现有的搜索API来获取票据信息
  return request.get('/ticketing/tickets/sales/search', {
