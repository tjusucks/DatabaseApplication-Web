          ...
          <div class="log-container">
            <div class="section-title">
              ...
              <div class="log-controls">
                ...
                <el-button size="small" @click="pauseLogs" :type="logsPaused ? 'success' : 'warning'">
                  {{ logsPaused ? '继续' : '暂停' }}
                </el-button>
              </div>
            </div>
...
const logs = ref([
  { id: 1, timestamp: Date.now() - 5000, level: 'INFO', type: 'info', message: '系统启动完成，开始监控' },
  { id: 2, timestamp: Date.now() - 3000, level: 'WARN', type: 'warning', message: 'DEV003 温度超过预警线' },
  { id: 3, timestamp: Date.now() - 1000, level: 'ERROR', type: 'error', message: 'DEV005 温度异常，需要检查' },
]);
  ...
  const pressureOption = {
    ...
    series: [{
      ...
      axisLine: {
        lineStyle: {
          width: 20,
          color: [[0.3, '#ff6b6b'], [0.7, '#ffa726'], [1, '#4ecdc4']]
        }
      },
...
.trend-indicator.up { color: #4caf50; }
.trend-indicator.down { color: #f44336; }
.trend-indicator.stable { color: #ffc107; }
...
.status-danger .status-dot { background: #f44336; }
...
.log-info { border-left: 4px solid #4caf50; }
