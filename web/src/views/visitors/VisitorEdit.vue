  ...
  <div class="visitor-edit">
    ...
    <el-card class="form-card" v-loading="loading">
      ...
      >
        <el-row :gutter="24">
          ...
          <el-col :span="12">
            ...
            <el-form-item label="游客类型">
              <el-input
                :value="
                  originalData?.visitorType === 'Member' ? '会员' : '普通游客'
                "
                readonly
              >
                <template #append>
                  <el-tooltip
                    content="游客类型需要通过专门的会员管理功能修改"
                    placement="top"
                  >
                    <el-button size="small" disabled>
                      <el-icon><Lock /></el-icon>
        ...
        <!-- 会员信息区域 -->
        <div
          v-if="originalData?.visitorType === 'Member'"
          ...
          <el-row :gutter="24" style="margin-top: 16px">
            <el-col :span="8">
              <el-form-item label="会员等级">
                <el-input
                  :value="originalData?.memberLevel || 'Bronze'"
                  readonly
                />
              </el-form-item>
            </el-col>
            ...
            <el-col :span="8">
              <el-form-item label="成为会员时间">
                <el-input
                  :value="formatDate(originalData?.memberSince)"
                  readonly
                />
              </el-form-item>
            </el-col>
        ...
        <el-row :gutter="24">
          <el-col :span="12">
            <el-form-item label="黑名单状态">
              <el-input
                :value="originalData?.isBlacklisted ? '已拉黑' : '正常'"
                readonly
              >
                <template #append>
                  <el-tooltip
                    content="黑名单状态需要通过专门的黑名单管理功能修改"
                    placement="top"
                  >
                    <el-button size="small" disabled>
                      <el-icon><Lock /></el-icon>
          ...
          <el-col :span="12">
            <el-form-item label="注册时间">
              <el-input
                :value="formatDate(originalData?.user?.registerTime)"
                readonly
              />
            </el-form-item>
          </el-col>
...
const fetchVisitorDetail = async () => {
  try {
    ...
    form.birthDate = data.user?.birthDate
      ...
      : "";
    form.gender =
      data.user?.gender === "Male" ? 0 : data.user?.gender === "Female" ? 1 : 2;
...
const handleSubmit = async () => {
  try {
    ...
    const basicData = {
      ...
      gender:
        form.gender === 0 ? "Male" : form.gender === 1 ? "Female" : "Other",
