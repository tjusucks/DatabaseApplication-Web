        ...
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-form-item label="员工类型" prop="staffType">
              <el-select v-model="employeeForm.staffType" placeholder="请选择员工类型" clearable style="width: 100%;">
                <el-option
          ...
          <el-col :span="12">
            <el-form-item label="工作状态" prop="employmentStatus">
              <el-select v-model="employeeForm.employmentStatus" placeholder="请选择工作状态" clearable style="width: 100%;">
                <el-option
