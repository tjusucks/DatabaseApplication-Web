              ...
              <el-col :span="6">
                <div class="statistic-card">
                  <el-statistic :value="statistics.totalReviews">
                    <template #title>
                      <div style="display: inline-flex; align-items: center">总绩效记录</div>
                    </template>
                  </el-statistic>
                </div>
              </el-col>
              <el-col :span="6">
                <div class="statistic-card">
                  <el-statistic :value="statistics.averageScore" :precision="2">
                    <template #title>
                      <div style="display: inline-flex; align-items: center">平均分</div>
                    </template>
                  </el-statistic>
                </div>
              </el-col>
              <el-col :span="6">
                <div class="statistic-card">
                  <el-statistic :value="statistics.excellentReviews">
                    <template #title>
                      <div style="display: inline-flex; align-items: center">优秀绩效</div>
                    </template>
                  </el-statistic>
                </div>
              </el-col>
              <el-col :span="6">
                <div class="statistic-card">
                  <el-statistic :value="statistics.poorReviews">
                    <template #title>
                      <div style="display: inline-flex; align-items: center">不合格绩效</div>
                    </template>
                  </el-statistic>
                </div>
              </el-col>
