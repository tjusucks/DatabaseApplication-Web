    ...
    >
      ...
      >
        ...
        <el-form-item label="评级" prop="evaluationLevel">
          <el-select v-model="reviewForm.evaluationLevel" placeholder="请选择评级" style="width: 100%">
...
import { getEmployeeReviews, createEmployeeReview, updateEmployeeReview, deleteEmployeeReview } from '@/api/hr'
...
const fetchReviews = async () => {
  ...
  try {
    ...
    Object.keys(params).forEach(key => {
      if (params[key] === '' || params[key] === null || (typeof params[key] === 'string' && params[key].trim() === '')) {
        delete params[key]
      }
    })
