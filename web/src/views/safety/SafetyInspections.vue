      ...
      <el-table :data="inspections" :loading="loading" @row-click="editInspection">
        ...
        <el-table-column label="操作" width="150" fixed="right">
          <template #default="{ row }">
            ...
            <el-button size="small" type="danger" @click.stop="confirmDelete(row.inspectionId)">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
    ...
    >
      ...
      >
        ...
        <el-form-item label="游乐设施ID" prop="rideId">
          <el-input 
            v-model="form.rideId" 
            placeholder="请输入游乐设施ID" 
          />
        </el-form-item>

        <el-form-item label="游乐设施名称">
          <el-input 
            v-model="form.rideName" 
            placeholder="请输入游乐设施名称（可选）" 
          />
        </el-form-item>
